...
BEGIN
    ...
    IF p_is_abandoned_cart THEN
        ...
        END;
    ELSE
        -- Capture old agent before update
        ...
        -- ONLY increment counter for FRESH assignments (was unassigned -> now assigned)
        -- This keeps round-robin counts accurate without messing up manual reassignments
