...
-- FIX: The auto_assign_lead_round_robin trigger was NOT calling reset_daily_caps()
-- This meant assigned_today counters accumulated across days without resetting,
-- causing agents with lower caps (Isobel=20, Ash=20) to be skipped while
-- James (cap=30) still had room — breaking round-robin fairness.
...
BEGIN
    ...
    -- CRITICAL FIX: Reset daily caps before every assignment check
    -- Without this, assigned_today accumulates across days and agents
    -- with lower caps get permanently skipped until manual reset
