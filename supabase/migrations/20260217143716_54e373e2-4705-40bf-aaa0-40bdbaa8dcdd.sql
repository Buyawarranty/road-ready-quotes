...
-- Add step_abandoned to marketing_audience
ALTER TABLE public.marketing_audience ADD COLUMN IF NOT EXISTS step_abandoned integer;

-- Update the sync function to include step_abandoned
