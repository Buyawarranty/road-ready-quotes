...
const testimonials = [
  {
    ...
    text: "The power control unit failed at 72,000 miles. Panda Protect handled the entire claim and paid the garage directly. Incredible service.",
    rating: 5
  },
  {
    name: "Mark T.",
...
const PHEVWarrantyLanding: React.FC = () => {
  ...
  const serviceSchema = {
    ...
    "provider": { "@type": "LocalBusiness", "name": "Panda Protect", "url": "https://pandaprotect.co.uk", "telephone": "+44-330-229-5045", "priceRange": "£19-£99/month", "address": { "@type": "PostalAddress", "addressCountry": "GB" } },
  ...
  const organizationSchema = { "@context": "https://schema.org", "@type": "Organization", "name": "Panda Protect", "url": "https://pandaprotect.co.uk", "logo": "https://pandaprotect.co.uk/lovable-uploads/53652a24-3961-4346-bf9d-6588ef727aeb.png", "legalName": "BUY A WARRANTY LIMITED", "description": "UK's trusted extended vehicle warranty provider since 2016. Specialist in PHEV, hybrid, electric, car, and van warranty cover.", "foundingDate": "2016", "areaServed": { "@type": "Country", "name": "United Kingdom" }, "sameAs": ["https://uk.trustpilot.com/review/pandaprotect.co.uk"], "contactPoint": { "@type": "ContactPoint", "telephone": "+44-330-229-5045", "contactType": "customer service", "areaServed": "GB", "availableLanguage": "English" } };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="abstract" content="Panda Protect offers specialist PHEV plug-in hybrid vehicle warranty cover across the United Kingdom from £19 per month covering electric motors, inverters, on-board chargers and 1,000+ components." />
        ...
        <meta name="ai-entity" content="Panda Protect | Type: UK Automotive Warranty Provider | Founded: 2016 | Speciality: PHEV Plug-in Hybrid Extended Warranty | Price: From £19/month | Rating: 4.8/5 (2,847 reviews) | Phone: 0330 229 5045" />
        ...
        <meta property="og:description" content="UK's No.1 specialist PHEV warranty. Covers electric motors, inverters, on-board chargers, battery management & 1,000+ parts across 100+ plug-in hybrid models. Unlimited claims at any garage. 60-second quote — 14-day money-back guarantee. 0330 229 5045." />
                ...
                <div className="max-w-md mx-auto lg:mx-0 space-y-4">
                  ...
                  <div className="mt-5 bg-gray-50 border border-gray-200 rounded-xl shadow-sm px-5 py-4 text-center">
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-x-1.5 gap-y-1 text-xs sm:text-[15px] mt-1.5">
                      ...
                      <a href="tel:03302295045" className="font-semibold text-gray-900 hover:underline">0330 229 5045</a>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid lg:grid-cols-3 gap-6 md:gap-8 items-start">
              ...
              <div className="hidden lg:flex justify-center items-end">
                <OptimizedImage src={phevVolvoXC60} alt="PHEV plug-in hybrid warranty UK - Volvo XC60 Recharge covered by Panda Protect" className="w-[400px] h-auto object-contain" width={400} height={300} />
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-6 md:gap-10 items-center">
              <div className="flex justify-center">
                <OptimizedImage src={pandaThumbsUp} alt="High mileage PHEV warranty coverage UK - Panda Protect" className="w-64 sm:w-80 md:w-96 lg:w-[28rem] h-auto object-contain" width={448} height={300} />
              </div>
              <div className="text-center lg:text-left">
        ...
        <section className="py-12 md:py-20 bg-brand-orange">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <a href="tel:03302295045" className="inline-flex items-center gap-2 text-white font-bold text-base md:text-xl hover:text-white/80 transition-colors">
                <Phone className="w-5 h-5 md:w-6 md:h-6" /> 0330 229 5045
              </a>
            </div>
          </div>
        </section>
