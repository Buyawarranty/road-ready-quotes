...
const TradeOnlyPage: React.FC = () => {
  ...
  return (
    <>
      ...
      <main className={`${isStaticInformationPage ? 'public-static-page public-trade-info-page' : 'public-landing-page public-warranty-landing'} bg-background min-h-screen`}>
        {/* Hero */}
